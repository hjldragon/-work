...
class AgentEntry
{
    ...
    public $pay_password    = null;           // 支付密码
    public $pay_phone       = null;           // 支付绑定手机号
    ...
    public function FromMgo($cursor)
    {
        ...
        $this->pay_password    = $cursor['pay_password'];
        $this->pay_phone       = $cursor['pay_phone'];
    }
...
class Agent
{
    ...
    public function Save(&$info)
    {
        ...
        if (null !== $info->pay_password) {
            $set["pay_password"] = (string)$info->pay_password;
        }
        if (null !== $info->pay_phone) {
            $set["pay_phone"] = (string)$info->pay_phone;
        }
