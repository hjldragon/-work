...
class Cfg
{
    ...
    static private $module = "mart"; // 运营平台端
    public $db   = null;
    public $log  = null;
    public $rsa  = null;
    public $img  = null;
    ...
    private function Init()
    {
        ...
        // 日志配置
        $path = Util::EmptyToDefault($cfg["log.path"], "/log/mart.jzzwlcm.com/log.txt");
        if(file_exists($path))
        {
...
eof;
        ...
        // 点餐页面地址
        $this->ordering_url = Util::EmptyToDefault($cfg["ordering_url"], "http://customer.xinchihuo.com/menu.php");
