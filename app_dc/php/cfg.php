...
class Cfg
{
    ...
    static private $module = "dining"; // 店铺点餐机端
    public $db   = null;
    public $log  = null;
    public $rsa  = null;
    public $img  = null;
    ...
    private function Init()
    {
        ...
        // 日志配置
        $path = Util::EmptyToDefault($cfg["log.path"], "/log/dining.jzzwlcm.com/log.txt");
        if(file_exists($path))
        {
...
eof;
        ...
        //$this->food_url     = Util::EmptyToDefault($cfg["food_url"], "http://customer.jzzwlcm.com/#/shareFoodDetail");
