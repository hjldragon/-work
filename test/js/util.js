...
var Util = {
    ...
    EncSubmit : function(url, data, resp_func/*, other --> {dataType:xxx, mimeType:xxx, ...}*/)
    {
        ...
        var param = {
                token   : token,
                userid  : ((((JSON.parse(localStorage.getItem('public#shopinfo'))||{}).value||{}).userinfo||{}).userid||""), //window.Store.GetGlobalData('userid'),
                encmode : encmode,
                data    : datastr,
    ...
    Menu : function($owner, list, menu_click_func, property)
    {
        ...
        function AddItem($ul, data, pos)
        {
            ...
            // $li.append('<span class="delete-item">删除</span>');
