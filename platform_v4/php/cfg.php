...
class Cfg extends \Pub\Cfg
{
    ...
    protected function Init()
    {
        ...
        // 微信支付相关设置
        $wxpay = (object)[
            'appid' => Util::EmptyToDefault($cfg["wxpay.appid"], "wxaaceede0e7695fcf"),
            'secret' => Util::EmptyToDefault($cfg["wxpay.secret"], "eb03a81d333f75a937cb9bd3d4aa5273"),
            'mch_id' => Util::EmptyToDefault($cfg["wxpay.mch_id"], "1464120802"),
            'key' => Util::EmptyToDefault($cfg["wxpay.key"], "dada0cc3266ca659e2c0be29798eb357"),
            'notify_url' => Util::EmptyToDefault($cfg["wxpay.notify_url"], "http://vendor.jzzwlcm.com:8084/php/wx_notify_pay.php"),
        ];
        // 设置微信支付参数
        \Wx\Util::Init($wxpay);
        // 版本升级
