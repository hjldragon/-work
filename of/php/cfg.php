...
class Cfg
{
    ...
    static private $module = "customer"; // 微信点餐机端
    public $db   = null;
    public $log  = null;
    public $rsa  = null;
    public $img  = null;
    ...
    private function Init()
    {
        ...
        // 日志配置
        $path = Util::EmptyToDefault($cfg["log.path"], "/log/customer.jzzwlcm.com/log.txt");
        if(file_exists($path))
        {
...
eof;
        ...
        // 微信接口地址
        $this->wx_url_addr  = Util::EmptyToDefault($cfg["wx_url_addr"], "http://wx.jzzwlcm.com");
