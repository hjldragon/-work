...
function GetAllReservationList(&$resp)
{
    ...
    if($_['srctype'])
    {
        ShopPermissionCheck::PageCheck(ShopPermissionCode::SEE_RESERVATION);
    }else{
        ShopPermissionCheck::PageCheck(ShopPermissionCode::RESERVATION_LIST);
    }
...
//    if($_['srctype'] == 3)
//    {
//        Permission::PadUserPermissionCheck(Position::USRPREDETET);
//    }
