...
class AuthorizeEntry
{
    ...
    public $pc_num           = null;    // pc登录名额
    public $pad_num          = null;    // pad登录名额
    public $cashier_num      = null;    // 收银机登录名额
    public $app_num          = null;    // app登录名额
    public $used_pc_num      = null;    // 已分配的pc登录名额
    public $used_pad_num     = null;    // 已分配的pad登录名额
    public $used_cashier_num = null;    // 已分配的收银机登录名额
    public $used_app_num     = null;    // 已分配的app登录名额
