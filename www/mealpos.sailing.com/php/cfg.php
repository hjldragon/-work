...
//     static private $module = "mealpos"; // 自助售货机端
//     public $db   = null;
//     public $log  = null;
//     public $rsa  = null;
//     public $img  = null;
...
//         // 日志配置
//         $path = Util::EmptyToDefault($cfg["log.path"], "/log/mealpos.sailing.com/log.txt");
//         if(file_exists($path))
//         {
...
//         // 点菜宝跳转页面
//         $this->wx_mealpos_html = Util::EmptyToDefault($cfg["wx_mealpos_url"], "/www/mealpos.sailing.com/jump.html");
...
//     public function GetWxMealposHtml()
//     {
//         return $this->wx_mealpos_html;
//     }
// };
