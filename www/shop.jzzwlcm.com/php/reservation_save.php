...
function SaveReservation(&$resp)
{
    ...
    if($reservation_id)
    {
        ShopPermissionCheck::PageCheck(ShopPermissionCode::EDIT_RESERVATION);
    }else{
        ShopPermissionCheck::PageCheck(ShopPermissionCode::ADD_RESERVATION);
    }
    ...
    $info           =  $mgo->GetReservationByTime($reservation_time,$seat_id);
    if($info->seat_id)
    {
        LogErr('seat is reservation');
        return errcode::SEAT_HAVE_RES;
    }
...
function SaveReservationState(&$resp)
{
    ...
    {
        ShopPermissionCheck::PageCheck(ShopPermissionCode::COME_SHOP);
    ...
    {
        ShopPermissionCheck::PageCheck(ShopPermissionCode::DEL_RESERVATION);
        $reserve_info->reservation_status = $reservation_status;
