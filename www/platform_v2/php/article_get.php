...
{
    PlPermissionCheck::PageCheck(PlPermissionCode::VISIT_ARTICLE);
    $_ = $GLOBALS["_"];
    if(!$_)
    {
        LogErr("param err");
    ...
    $desc          = $_['desc'];
    if($article_type || $title || $article_state || $end_time || $begin_time || $platformer_id)
    {
        PlPermissionCheck::PageCheck(PlPermissionCode::SEEK_ARTICLE);
    }
