...
eof;
        ...
        // 点餐页面地址
        $this->ordering_url = Util::EmptyToDefault($cfg["ordering_url"], "http://of.jzzwlcm.com/menu.php");
        $this->menu_url     = Util::EmptyToDefault($cfg["menu_url"], "http://customer.jzzwlcm.com/index.php");
        $this->food_url     = Util::EmptyToDefault($cfg["food_url"], "http://shop.jzzwlcm.com/good/foodDetail");
