...
class Unifiedorder
{
    ...
    public function Submit()
    {
        ...
        {
            $this->value['openid'] = \Pub\Wx\Util::GetOpenid();  // 用户标识
        }

        $this->value['appid']            = \Pub\Wx\Cfg::APPID;  // 公众账号ID
        $this->value['mch_id']           = \Pub\Wx\Cfg::MCH_ID;  // 商户号
        ...
        $this->value['sign']             = \Pub\Wx\Util::GetSign($this->value);  // 签名
        LogDebug($this->value);
        $xml = \Pub\Wx\Util::ToXml($this->value);
        // echo htmlspecialchars($xml) . "<hr>";
        $ret = \Pub\Wx\Util::HttpPost(\Pub\Wx\Cfg::WX_URL_UNIFIEDORDER, $xml);
        return $ret;
    }
    ...
    public function SubmitMicropay()
    {
        ...
        $xml = \Pub\Wx\Util::ToXml($this->value);
        $ret = \Pub\Wx\Util::HttpPost(\Pub\Wx\Cfg::WX_URL_MICROPAY, $xml);
    ...
    public function SubmitOrder()
    {
        ...
        $xml = \Pub\Wx\Util::ToXml($this->value);
        $ret = \Pub\Wx\Util::HttpPost(\Pub\Wx\Cfg::WX_URL_ORDERQUERY, $xml);
        //echo htmlspecialchars($ret) . "<hr>";die;
        return $ret;
    }
    ...
    public function SubmitSend($openid, $content, $access_token)
    {
        ...
        $url = \Pub\Wx\Cfg::WX_URL_SEND. "?access_token=$access_token";
        $ret = \Pub\Wx\Util::HttpPost($url, $data);
        return $ret;
    }
    ...
    public function SubmitRefund()
    {
        ...
        $xml = \Pub\Wx\Util::ToXml($this->value);
        LogDebug($xml);
        LogDebug(\Pub\Wx\Cfg::WX_URL_REFUND);
        // echo htmlspecialchars($xml) . "<hr>";
        $ret = \Pub\Wx\Util::HttpPost(\Wx\Cfg::WX_URL_REFUND, $xml);
        return $ret;
    }
}
