...
function SaveCategory(&$resp)
{
    ...
    if($category_id)
    {
        ShopPermissionCheck::PageCheck(ShopPermissionCode::EDIT_CATEGORY);
    }else{
        ShopPermissionCheck::PageCheck(ShopPermissionCode::ADD_CATEGORY);
    }
...
function DeleteCategory(&$resp){
    ...
    ShopPermissionCheck::PageCheck(ShopPermissionCode::DEL_CATEGORY);
    $_=$GLOBALS["_"];
    LogDebug($_);
    if(!$_){
        LogErr("param err");
