...
function SaveNewsinfo(&$resp)
{
    ...
    if(!$news_id)
    {
        ShopPermissionCheck::PageCheck(ShopPermissionCode::SEND_NEWS);
...
function DeleteNews(&$resp)
{
    ...
    if($is_draft)
    {
        ...
        ShopPermissionCheck::PageCheck(ShopPermissionCode::DEL_NEWS);
    }
...
{
    ShopPermissionCheck::PageCheck(ShopPermissionCode::IS_READY_SYSTEM);
    $ret = ReadyNews($resp);
}
else if(isset($_['del_sysnews']))
{
    ShopPermissionCheck::PageCheck(ShopPermissionCode::DEL_SYTEM);
