...
class AgentEntry
{
    ...
    public $solar_rebates   = null;           // 软件享有折扣率
    public $hdw_rebates     = null;           // 硬件享有折扣率
    public $dymo_rebates    = null;           // 耗材享有折扣率
    ...
    public function FromMgo($cursor)
    {
        ...
        $this->solar_rebates   = $cursor['solar_rebates'];
        $this->hdw_rebates     = $cursor['hdw_rebates'];
        $this->dymo_rebates    = $cursor['dymo_rebates'];
    }
