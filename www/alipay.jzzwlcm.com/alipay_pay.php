...
$referer = "http://$module.$main_domain/index.html?shop_id=$order_info->shop_id&seat_id=$order_info->seat_id&customer_id=$order_info->customer_id&userid=$customer_info->userid/#/payFail?order_id=$order_id";
$ref     = "http://$module.$main_domain/index.html?shop_id=$order_info->shop_id&seat_id=$order_info->seat_id&customer_id=$order_info->customer_id&userid=$customer_info->userid/#/order?order_id=$order_id";
