...
function SaveArticleInfo(&$resp)
{
    ...
    if($article_id)
    {
        PlPermissionCheck::PageCheck(PlPermissionCode::EDIT_ARTICLE);
    }else{
        PlPermissionCheck::PageCheck(PlPermissionCode::ADD_ARTICLE);
    }
...
{
    PlPermissionCheck::PageCheck(PlPermissionCode::DEL_ARTICLE);
    $_ = $GLOBALS["_"];
    if(!$_)
    {
        LogErr("param err");
...
{
    PlPermissionCheck::PageCheck(PlPermissionCode::CLOSE_ARTICLE);
    $_ = $GLOBALS["_"];
    if(!$_)
    {
        LogErr("param err");
