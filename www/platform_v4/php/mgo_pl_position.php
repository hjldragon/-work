...
class PLPosition
{
    ...
    public function Save(&$info)
    {
        ...
        {
//            foreach($info->pl_position_permission as $i => $item)
//            {
//                $set['pl_position_permission.'.$i] = $item;
//            }
            $set["pl_position_permission"] = $info->pl_position_permission;
        }
    ...
    public function GetPositionByAudit($audit_person_list)
    {
        $db = \DbPool::GetMongoDb();
        $table = $db->selectCollection($this->Tablename());
